...
最終層の[CLS]トークンを文ベクトルとし、全文ペアの類似度を求める。
"""
...
def get_cls_vectors(sentences: list[str]) -> torch.Tensor:
    # 各文について、BERT最終層の[CLS]ベクトルを返す
...
def main() -> None:
    vectors = get_cls_vectors(SENTENCES)
