...
（解説）
イ　810年（弘仁元年）：薬子の変の直後に蔵人所が設置され、藤原冬嗣らが蔵人頭に任命されました。
ウ　842年（承和9年）：承和の変により、藤原良房が他氏を排斥して北家の地位を固めました。
ア　901年（昌泰4年）：昌泰の変により、藤原時平が菅原道真を大宰府へ左遷しました。"""